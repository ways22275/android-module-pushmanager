package com.greedyisgood.module.pushmanager.impl
...
import com.greedyisgood.module.pushmanager.models.NotificationData
import com.greedyisgood.module.pushmanager.models.NotificationType
import com.greedyisgood.module.pushmanager.models.RemoteMessageData
...
abstract class PushManagerMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (notification != null) {
            ...
            remoteMessageData.bodyLocalizationArgs = notification.bodyLocalizationArgs?.toList()
            ...
            remoteMessageData.titleLocalizationArgs = notification.titleLocalizationArgs?.toList()
        }
